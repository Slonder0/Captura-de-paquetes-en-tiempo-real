...
///CAMPOS DEL HEADER
void ID_DNS(const u_char* dato, pcap_t* archivo){
    printf("ID: ");
    //Leer bytes
    //IPv4
    if(dato[13]== 0x00){
...
void Flags_DNS(const u_char* dato, pcap_t* archivo){
...
unsigned int QDcount(const u_char* dato, pcap_t* archivo){
...
unsigned int ANcount(const u_char* dato, pcap_t* archivo){
    unsigned int datobin = 0;
...
unsigned int NScount(const u_char* dato, pcap_t* archivo){
    unsigned int datobin = 0;
...
unsigned int ARcount(const u_char* dato, pcap_t* archivo){
    unsigned int datobin = 0;
...
///CAMPOS DE QUESTION
void NombreQD_DNS(const u_char* dato, pcap_t* archivo){
...
void Tipo_DNS(const u_char* dato, pcap_t* archivo){
    int datobin = 0;
...
void Class_DNS(const u_char* dato, pcap_t* archivo){
    int datobin = 0;
...
///CAMPOS ANSWER
void NombreAN_DNS(const u_char* dato, pcap_t* archivo, unsigned int AN){
    int datobin;//Dato para guardar decimal
    char dominio;
...
void TTL_DNS(const u_char* dato, pcap_t* archivo){
    int datobin = 0;
...
int Longitud_DNS(const u_char* dato, pcap_t* archivo){
    int datobin = 0;
...
int RDATA(const u_char* dato, pcap_t* archivo){
    int datobin = 0,longitud;
    char ascii;

    longitud = Longitud_DNS(dato,archivo);
